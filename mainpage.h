 ...
 * @section Description
 *
 * The files in this project comprise the MultiSpecies utility classes.  These
 * constants, namespaces, classes, and functions are commonly used throughout the
