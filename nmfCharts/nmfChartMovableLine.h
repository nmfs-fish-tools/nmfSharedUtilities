/**
 * @file nmfChartMovableLine.h
 * @brief Definition for the Movable Line widget
 * @date Feb 16, 2018
 *
 * This file contains the definition for the Movable Line widget which is currently
 * used in the REMORA tool.
 *
 * @copyright
